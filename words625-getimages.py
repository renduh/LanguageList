...
adjectives_eng = ['Adjectives', 'long', 'short', 'tall', 'wide', 'narrow', 'big', 'large', 'small', 'little', 'slow', 'fast', 'hot', 'cold', 'warm', 'cool', 'new', 'old', 'young', 'good', 'bad', 'wet', 'dry', 'sick', 'healthy', 'loud', 'quiet', 'happy', 'sad', 'beautiful', 'ugly', 'deaf', 'blind', 'nice', 'mean', 'rich', 'poor', 'thick', 'thin', 'expensive', 'cheap', 'flat', 'curved', 'male', 'female', 'tight', 'loose', 'high', 'low', 'soft', 'hard', 'deep', 'shallow', 'clean', 'dirty', 'strong', 'weak', 'dead', 'alive', 'heavy', 'light', 'dark', 'nuclear', 'famous']
adjectives_cy = []
adjectives_img = []

pronouns_eng = ['Pronouns', 'I', 'you', 'he', 'she', 'it', 'we', 'they']
pronouns_cy = []
pronouns_img = []
...
for array in allarrays:
  ...
  for word in eval(array):
  	searchword = firstword + '-' + word
  	print(searchword)
  	google_crawler = BingImageCrawler(storage={'root_dir': 'img625'})
  	filters = dict(
  		size='medium',
  		layout='square')
  	google_crawler.crawl(keyword=word, filters=filters, max_num=1)
  	newsavename = 'img625/' + searchword + '.jpg'
  	if os.path.isfile('img625/000001.jpg'):
  		os.rename('img625/000001.jpg', newsavename)
  print(' ')